...
//    NavHost(navController = navController as NavHostController, startDestination = BottomBarItemScreen.Home.route) {
//        composable(BottomBarItemScreen.Home.route) { HomeScreen(navControllerBottomBar = navController) }
//        composable(BottomBarItemScreen.Timers.route) { TimersScreen(navControllerBottomBar = navController }
//        composable(BottomBarItemScreen.Profile.route) { ProfileScreen(navControllerBottomBar = navControllerBottomBar, navControllerScreens= navControllerScreens) }
//    }
//}